...
function addFavorite(req, res, next) {
  db.one('insert into favorites(movie_id, user_id, title, poster_path, release_date, vote_average, overview, genre_ids)' +
  'values(${movie_id}, ${user_id}, ${title}, ${poster_path}, ${release_date}, ${vote_average}, ${overview}, ${genre_ids}) returning id', req.body)
  .then(function(data) {
